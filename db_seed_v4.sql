/*
FoodGenieGemini Database Seed Script V4
- Creates a new database 'FoodGenieGemini'
- Renamed 'timestamp' column to 'activity_timestamp' to avoid keyword conflicts
- Removed inline comments in VALUES clauses to prevent parsing errors
- Added GO statements between blocks for better error isolation
*/
...
CREATE TABLE Activities (
    ...
    title NVARCHAR(200),
    description NVARCHAR(MAX),
    activity_timestamp NVARCHAR(50), -- Renamed from timestamp
    likes INT,
    comments INT,
    image NVARCHAR(255),
