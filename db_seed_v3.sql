/*
FoodGenieGemini Database Seed Script V3
- Creates a new database 'FoodGenieGemini'
- Fixes potential keyword conflicts (timestamp)
...
CREATE TABLE Activities (
    ...
    title NVARCHAR(200),
    description NVARCHAR(MAX),
    [timestamp] NVARCHAR(50), -- Quoted to avoid keyword conflict
    likes INT,
    comments INT,
    image NVARCHAR(255),
...
(36, 'Tomato', '/1/20/22/35/36/', 35, 'generic_food', NULL, NULL, '["Basil", "Mozzarella", "Olive Oil", "Balsamic"]', NULL);
